...
class _ProfileRemoteDatasource implements ProfileRemoteDatasource {
  ...
  @override
  Future<ProfileResponse> createProfile(UpdateProfileRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  @override
  Future<ProfileResponse> updateProfile(UpdateProfileRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  @override
  Future<ProfileResponse> patchProfile(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
