...
mixin _$QueueStatusResponse {
 ...
 bool? get inQueue; int? get position; int? get queueSize; int? get waitSeconds; int? get expiresInSeconds; String? get preference; bool? get timedOut; String? get roomId; String? get partnerId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,inQueue,position,queueSize,waitSeconds,expiresInSeconds,preference,timedOut,roomId,partnerId);

@override
String toString() {
  return 'QueueStatusResponse(inQueue: $inQueue, position: $position, queueSize: $queueSize, waitSeconds: $waitSeconds, expiresInSeconds: $expiresInSeconds, preference: $preference, timedOut: $timedOut, roomId: $roomId, partnerId: $partnerId)';
}
...
@useResult
$Res call({
 bool? inQueue, int? position, int? queueSize, int? waitSeconds, int? expiresInSeconds, String? preference, bool? timedOut, String? roomId, String? partnerId
});
...
/// Create a copy of QueueStatusResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? inQueue = freezed,Object? position = freezed,Object? queueSize = freezed,Object? waitSeconds = freezed,Object? expiresInSeconds = freezed,Object? preference = freezed,Object? timedOut = freezed,Object? roomId = freezed,Object? partnerId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool? inQueue,  int? position,  int? queueSize,  int? waitSeconds,  int? expiresInSeconds,  String? preference,  bool? timedOut,  String? roomId,  String? partnerId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QueueStatusResponse() when $default != null:
return $default(_that.inQueue,_that.position,_that.queueSize,_that.waitSeconds,_that.expiresInSeconds,_that.preference,_that.timedOut,_that.roomId,_that.partnerId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool? inQueue,  int? position,  int? queueSize,  int? waitSeconds,  int? expiresInSeconds,  String? preference,  bool? timedOut,  String? roomId,  String? partnerId)  $default,) {final _that = this;
switch (_that) {
case _QueueStatusResponse():
return $default(_that.inQueue,_that.position,_that.queueSize,_that.waitSeconds,_that.expiresInSeconds,_that.preference,_that.timedOut,_that.roomId,_that.partnerId);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool? inQueue,  int? position,  int? queueSize,  int? waitSeconds,  int? expiresInSeconds,  String? preference,  bool? timedOut,  String? roomId,  String? partnerId)?  $default,) {final _that = this;
switch (_that) {
case _QueueStatusResponse() when $default != null:
return $default(_that.inQueue,_that.position,_that.queueSize,_that.waitSeconds,_that.expiresInSeconds,_that.preference,_that.timedOut,_that.roomId,_that.partnerId);case _:
  return null;
...
class _QueueStatusResponse implements QueueStatusResponse {
  const _QueueStatusResponse({this.inQueue, this.position, this.queueSize, this.waitSeconds, this.expiresInSeconds, this.preference, this.timedOut, this.roomId, this.partnerId});
...
/// Create a copy of QueueStatusResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? inQueue = freezed,Object? position = freezed,Object? queueSize = freezed,Object? waitSeconds = freezed,Object? expiresInSeconds = freezed,Object? preference = freezed,Object? timedOut = freezed,Object? roomId = freezed,Object? partnerId = freezed,}) {
