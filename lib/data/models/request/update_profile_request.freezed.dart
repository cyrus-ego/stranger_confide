...
mixin _$UpdateProfileRequest {
 ...
 String get displayName; String get gender; int get age; String get bio; String get chatPreference; String get preferredGender;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateProfileRequest&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.age, age) || other.age == age)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.chatPreference, chatPreference) || other.chatPreference == chatPreference)&&(identical(other.preferredGender, preferredGender) || other.preferredGender == preferredGender));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,displayName,gender,age,bio,chatPreference,preferredGender);

@override
String toString() {
  return 'UpdateProfileRequest(displayName: $displayName, gender: $gender, age: $age, bio: $bio, chatPreference: $chatPreference, preferredGender: $preferredGender)';
}
...
@useResult
$Res call({
 String displayName, String gender, int age, String bio, String chatPreference, String preferredGender
});
...
/// Create a copy of UpdateProfileRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? displayName = null,Object? gender = null,Object? age = null,Object? bio = null,Object? chatPreference = null,Object? preferredGender = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String displayName,  String gender,  int age,  String bio,  String chatPreference,  String preferredGender)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateProfileRequest() when $default != null:
return $default(_that.displayName,_that.gender,_that.age,_that.bio,_that.chatPreference,_that.preferredGender);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String displayName,  String gender,  int age,  String bio,  String chatPreference,  String preferredGender)  $default,) {final _that = this;
switch (_that) {
case _UpdateProfileRequest():
return $default(_that.displayName,_that.gender,_that.age,_that.bio,_that.chatPreference,_that.preferredGender);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String displayName,  String gender,  int age,  String bio,  String chatPreference,  String preferredGender)?  $default,) {final _that = this;
switch (_that) {
case _UpdateProfileRequest() when $default != null:
return $default(_that.displayName,_that.gender,_that.age,_that.bio,_that.chatPreference,_that.preferredGender);case _:
  return null;
...
class _UpdateProfileRequest implements UpdateProfileRequest {
  const _UpdateProfileRequest({required this.displayName, required this.gender, required this.age, required this.bio, required this.chatPreference, required this.preferredGender});
...
/// Create a copy of UpdateProfileRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? displayName = null,Object? gender = null,Object? age = null,Object? bio = null,Object? chatPreference = null,Object? preferredGender = null,}) {
